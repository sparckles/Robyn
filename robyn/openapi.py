...
class RouteOpenAPIMeta:
    ...
    Mirrors the familiar FastAPI knobs so handlers can document their
    behaviour without hand-writing the spec.
...
# Mirrors the representation Pydantic/FastAPI emit for these stdlib types so
