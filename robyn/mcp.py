...
class MCPHandler:
    ...
    def __init__(self):
        ...
        self.server_info = {
            "name": "robyn-mcp-server",
            "version": "1.0.0"
        }
    
    def register_resource(self, uri: str, name: str, handler: Callable, 
                         description: Optional[str] = None, mime_type: Optional[str] = None):
        """Register a resource handler"""
        self.resources[uri] = handler
        self.resource_metadata[uri] = MCPResource(
    ...
    def register_tool(self, name: str, handler: Callable, description: str, 
        ...
        self.tool_metadata[name] = MCPTool(
    ...
    def register_prompt(self, name: str, handler: Callable, description: str,
        ...
        self.prompt_metadata[name] = MCPPrompt(
    ...
    async def _handle_get_prompt(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            "description": self.prompt_metadata[name].description,
            "messages": messages
        }
...
class MCPApp:
    ...
    def resource(self, uri: str = None, name: str = None, description: Optional[str] = None, 
