...
class MCPHandler:
    ...
    async def _handle_list_resources(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        resources = []
        for _uri, metadata in self.resource_metadata.items():
    ...
    async def _handle_list_tools(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        tools = []
        for _name, metadata in self.tool_metadata.items():
    ...
    async def _handle_list_prompts(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        prompts = []
        for _name, metadata in self.prompt_metadata.items():
...
class MCPApp:
    ...
    def tool(self, name: str | None = None, description: str | None = None, input_schema: dict[str, Any] | None = None):
        """
    ...
    def prompt(self, name: str | None = None, description: str | None = None, arguments: list[dict[str, Any]] | None = None):
        """
