...
| `max_connections` | 1000 | 最大并发连接数 | `ROBYN_MAX_CONNECTIONS` |
...
- 较高的 `max_connections` (2000-10000)

**对于长时间运行的操作：**
- 较高的 `client_timeout` (60-300秒)
- 标准的 `keep_alive_timeout` (20-30秒)
- 中等的 `max_connections` (500-2000)
