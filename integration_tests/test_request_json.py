...
def test_json_object_with_array(endpoint):
    ...
    test_data = {"sources": ["google_docs", "notion"]}
    response = post(endpoint, json=test_data)
...
def test_original_issue_1145_case():
    ...
    payload = {"sources": ["google_docs", "notion"]}
...
def test_complex_nested_structures(endpoint):
    ...
    test_data = [{"id": 1, "sources": ["google", "bing"]}, {"id": 2, "sources": ["yahoo", "duckduckgo"]}, ["item1", "item2", ["nested", "array"]]]
